...
public class Task extends Component{
    ...
    void updateDuration(Duration newDuration) {
        ...
        if(this.parentProject.duration!=null){
            parentProject.setDuration(this.duration.plusSeconds(parentProject.duration.getSeconds()).minusSeconds(parentProject.duration.getSeconds()));
        }
        else{
    ...
    public void stopTask(){
        setDateFinal(LocalDateTime.now());
    }
