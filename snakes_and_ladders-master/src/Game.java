...
public final class Game {
	...
	public Game(String[] playerNames, int numSquares, int[] deathSquares,
				int[][] snakes, int[][] ladders) {

		makeBoard(numSquares,deathSquares, ladders, snakes);
	...
	private void makeBoard(int numSquares, int[] deathSquares, int[][] ladders, int[][] snakes) {
		board = new Board(numSquares,deathSquares,ladders,snakes);
	}
