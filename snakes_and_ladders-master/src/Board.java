...
public final class Board {
	...
	//private Square death_square;
	private static final int MIN_NUM_SQUARES = 10;

	public Board(int numSquares,int[] deathSquares, int[][] ladders, int[][] snakes) {
	...
	private void makeDeathSquares(int [] deathSquares){
		for (int i=0; i<deathSquares.length ; i++) {
			int positionSquareDeath=deathSquares[i]-1;

			System.out.println("death square in " + deathSquares[i]);
			squares.set(positionSquareDeath,new DeathSquare(positionSquareDeath,this));
